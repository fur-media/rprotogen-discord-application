/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e73fba191cbfd06c0d8fc2b7e77c4127)
...
declare namespace Cloudflare {
	interface Env {
		...
		DISCORD_BASE_API_PATH: string;
		GUILD_ID: string;
		GUILD_MOD_ROLE_ID: string;
		GUILD_MOD_CONTACT_CHANNEL_ID: string;
		GUILD_MOD_MAIL_CATEGORY_ID: string;
		GUILD_MOD_MAIL_LOGS_CHANNEL_ID: string;
		GUILD_ALERT_AND_LOGGING_CHANNEL_ID: string;
		GUILD_ALERT_AND_LOGGING_THREAD_ID: string;
	}
}
